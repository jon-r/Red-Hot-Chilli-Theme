...
v23.click(function(){i=v16.find("img").attr("src");b=i.replace("gallery-tile","gallery");v22.find("img").length?v22.find("img").attr("src",b):(bN='<img src="'+b+'" >',v22.append(bN));v22.addClass("is-active")});v24.click(function(){f12(v22)});v26.click(function(){f11(v25)});v29.click(function(){f11(v28)});v27.click(function(){f12(v25)});v30.click(function(){f12(v28)});var v31=$("#js-question-in").find("option"),v32=$("#js-question-out");
...
v36.click(function(a){v41=$(this).parent("p.subform-active");v38=[];v40=v41.find(".response");v41.find(v34).each(function(){$el=$(this);f14($el)});v40.removeClass("success").removeClass("error").empty();console.log("click");0==v38.length?v41.removeClass("subform-active").next("p").addClass("subform-active"):v40.addClass("error").html("Please fill in required items")});v37.click(function(a){$(this).parent("p.subform-active").removeClass("subform-active").prev("p").addClass("subform-active")});

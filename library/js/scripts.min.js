...
!*/
function updateViewportDimensions(){var e=window,t=document,i=t.documentElement,r=t.getElementsByTagName("body")[0],l=e.innerWidth||i.clientWidth||r.clientWidth,a=e.innerHeight||i.clientHeight||r.clientHeight;return{width:l,height:a}}function throttle(e,t,i){t||(t=250);var r,l;return function(){var a=i||this,n=+new Date,s=arguments;r&&n<r+t?(clearTimeout(l),l=setTimeout(function(){r=n,e.apply(a,s)},t)):(r=n,e.apply(a,s))}}function setFixed(e){e.forEach(function(e){if(0==e.data("fixed")){var t=e.height(),i=e.width();e.addClass("is-fixed").data("fixed",1).after(divFiller).next(".js-filler").height(t).width(i)}}),isIndex&&(closeMainMenu(),moveMenu("in"))}function unsetFixed(e){e.forEach(function(e){1==e.data("fixed")&&e.removeClass("is-fixed").data("fixed",0).next(".js-filler").remove()}),isIndex&&moveMenu("out")}function moveMenu(e){var t=document.getElementById("primary-menu"),i=document.getElementById("js-sticky-left"),r=updateViewportDimensions();"in"==e?i.appendChild(t):"out"==e&&r.width>=481&&i.parentElement.insertBefore(t,i.nextElementSibling)}function findTop(e){var t=0;if(e.offsetParent)do t+=e.offsetTop;while(e=e.offsetParent);return t}function showSubMenu(e){bigScreen&&($row=$(e),$row.addClass("active-li"))}function hideSubMenu(e){$row=$(e),$row.removeClass("active-li")}function hideAllMenus(){bigScreen=!1,$navMain_li=$navMain_ul.find("li").removeClass("active-li")}function closeMainMenu(){$menuToggle.attr("checked",!1)}function ticker(){vp=updateViewportDimensions(),!hoverLock&&!timerLock&&vp.width>=481&&(tickerInt=tickerInt==slideCount?0:tickerInt+1,timerLock=!0,slideActivate(tickerInt))}function slideActivate(e){$carousel.find(".go-away").removeClass("is-active").removeClass("go-away"),$carousel.find(".is-active").addClass("go-away"),$slide.eq(e).removeClass("go-away").addClass("is-active"),$tabs.removeClass("active").eq(e).addClass("active"),setTimeout(function(){timerLock=!1},600)}function searchToText(e){var t=$.parseJSON(e);$searchOut.html(""),$(t).each(function(e){if(e<4){var t=fileSrc.site+"products/"+this.filter+"/"+this.url+"/",i="brand"==this.filter?"<span> - Brand</span>":"<span> - Category</span>",r='<li><a href="'+t+'" >'+this.name+i+"</a></li>";$searchOut.append(r)}})}function searchTraverse(e,t){$results=$searchOut.find("li > a"),$resultCount=$results.length,"down"==e&&t<$resultCount-1?(t++,$target=$results.eq(t),$text=$target.text(),$searchIn.val($text)):"up"==e&&(t>0?(t--,$target=$results.eq(t),$text=$target.text(),$searchIn.val($text)):$target=$searchIn),$target.focus()}function setMainImg(e){$thumbImg=$imgGalleryThumb.eq(e).find("img"),$getThumbSrc=$thumbImg.attr("src").replace("gallery-thumb","gallery"),$imgGalleryMain.addClass("loading"),1==$thumbImg.data("tile")?($tileSrc=$getThumbSrc.replace("gallery","gallery-tile"),$imgGalleryMain.removeClass("loading").find("img").attr("src",$tileSrc)):($.get(fileSrc.admin,{src:$getThumbSrc,size:"tile",action:"jr_resize"},replaceMainImg),$thumbImg.data("tile",1))}function replaceMainImg(e){var t=$.parseJSON(e);$newSrc=t,$imgGalleryMain.removeClass("loading").find("img").attr("src",$newSrc)}function modalOpen(e){e.addClass("is-active")}function modalOpenSmall(e){e.addClass("is-active-small")}function modalClose(e){e.removeClass("is-active"),e.removeClass("is-active-small")}function setVideo(e){$imgGalleryModal.append($.parseJSON(e))}function formValidate(e){var t=e.val(),i=e.attr("name"),r=e.attr("type"),l=t.match(/^[a-zA-Z0-9.!#$%&'*+\/=?^_`{|}~-]+@[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)*$/),a="";$formInputsReq.index(e);e.removeClass("error").removeClass("success").next("span").empty(),"email"!=r||l||(a="Please enter a valid email address",e.addClass("error")),t.length<1&&(a="Your "+i+" is required"),a.length>0?(e.addClass("error").next("span").text(a),formErrorList.push(a)):e.addClass("success")}function formAjaxReply(e){return function(t){var i=$.parseJSON(t);i.success?(e.parents(".modal-frame").addClass("modal-finished"),output=document.createElement("span"),output.textContent=i.output,output.className="form-output success",e.empty().append(output)):e.find(".response").removeClass("loading").addClass("error").html(i.output)}}!function(e){function t(t){var i=e(this),r=null,l=[],a=null,n=null,s=e.extend({rowSelector:"> li",submenuSelector:"*",submenuDirection:"right",tolerance:75,enter:e.noop,exit:e.noop,activate:e.noop,deactivate:e.noop,exitMenu:e.noop},t),o=3,c=300,m=function(e){l.push({x:e.pageX,y:e.pageY}),l.length>o&&l.shift()},u=function(){n&&clearTimeout(n),s.exitMenu(this)&&(r&&s.deactivate(r),r=null)},d=function(){n&&clearTimeout(n),s.enter(this),h(this)},$=function(){s.exit(this)},f=function(){g(this)},g=function(e){e!=r&&(r&&s.deactivate(r),s.activate(e),r=e)},h=function(e){var t=v();t?n=setTimeout(function(){h(e)},t):g(e)},v=function(){function t(e,t){return(t.y-e.y)/(t.x-e.x)}if(!r||!e(r).is(s.submenuSelector))return 0;var n=i.offset(),o={x:n.left,y:n.top-s.tolerance},m={x:n.left+i.outerWidth(),y:o.y},u={x:n.left,y:n.top+i.outerHeight()+s.tolerance},d={x:n.left+i.outerWidth(),y:u.y},$=l[l.length-1],f=l[0];if(!$)return 0;if(f||(f=$),f.x<n.left||f.x>d.x||f.y<n.top||f.y>d.y)return 0;if(a&&$.x==a.x&&$.y==a.y)return 0;var g=m,h=d;"left"==s.submenuDirection?(g=u,h=o):"below"==s.submenuDirection?(g=d,h=u):"above"==s.submenuDirection&&(g=o,h=m);var v=t($,g),p=t($,h),y=t(f,g),b=t(f,h);return y>v&&p>b?(a=$,c):(a=null,0)};i.mouseleave(u).find(s.rowSelector).mouseenter(d).mouseleave($).click(f),e(document).mousemove(m)}e.fn.menuAim=function(e){return this.each(function(){t.call(this,e)}),this}}(jQuery);var stickyRight=document.getElementById("js-sticky-right"),stickyLeft=document.getElementById("js-sticky-left"),$stRight=$(stickyRight),$stLeft=$(stickyLeft),$fixedHeader=[$stRight,$stLeft],titlePos=findTop(stickyLeft),divFiller='<div class="js-filler"></div>';window.onscroll=throttle(function(){scrollPos=window.scrollY,scrollPos>titlePos+40?setFixed($fixedHeader):unsetFixed($fixedHeader)},100),isIndex&&moveMenu("out");var $menuToggle=$("#menu-toggle"),$navMain_ul=$("#js-main-list"),$navMain_li=$navMain_ul.find("li"),bigScreen=!1;$navMain_ul.mouseenter(function(){vp=updateViewportDimensions(),vp.width>=1030?(bigScreen=!0,$navMain_ul.menuAim({activate:showSubMenu,deactivate:hideSubMenu,exitMenu:hideAllMenus})):bigScreen=!1}),$navMain_li.click(function(){$(this).toggleClass("active-li")}),$navMain_ul.mouseleave(function(){window.setTimeout(closeMainMenu,300)});var $carousel=$("#js-carousel-main"),$slide=$carousel.find(".slide"),$tabs=$("#js-carousel-blips > .blip"),slideCount=$slide.length-1,slideTime=8e3,hoverLock=!1,timerLock=!1,tickerInt=0;if($carousel.length>0){var carouselTimer=window.setInterval(ticker,slideTime);$carousel.mouseover(function(){hoverLock=!0}),$carousel.mouseout(function(){hoverLock=!1,clearInterval(carouselTimer),carouselTimer=window.setInterval(ticker,slideTime)}),$tabs.mouseover(function(){hoverLock=!0}),$tabs.mouseout(function(){hoverLock=!1,clearInterval(carouselTimer),carouselTimer=window.setInterval(ticker,slideTime)})}$tabs.click(function(){tickerInt==$(this).index()||timerLock||(timerLock=!0,tickerInt=$(this).index(),slideActivate(tickerInt))});var MIN_LENGTH=3,$searchForm=$("#js-form-complete").find(".form-search"),$searchIn=$searchForm.find(".search-in"),$searchOut=$searchForm.find(".search-out");$searchIn.keyup(function(){if(vp=updateViewportDimensions(),vp.width>=1030){var e=$(this).val();e.length>=MIN_LENGTH?$.get(fileSrc.admin,{keyword:e,action:"jr_autocomplete"}).done(searchToText):$searchOut.html("")}}),$searchIn.on("keydown",function(e){$results=$searchOut.find("li > a"),"40"==e.keyCode&&$results.length>0&&(e.preventDefault(),searchTraverse("down",-1))}),$searchOut.on("keydown","li > a",function(e){$focussed=$searchOut.find(":focus"),"40"==e.keyCode&&$focussed.length>0?(e.preventDefault(),$i=$(this).parent("li").index(),searchTraverse("down",$i)):"38"==e.keyCode&&$focussed.length>0&&(e.preventDefault(),$i=$(this).parent("li").index(),searchTraverse("up",$i))});var $imgGalleryMain=$("#js-gallery-primary"),$imgGalleryFull=$("#js-gallery-thumbs"),$imgGalleryThumb=$imgGalleryFull.find("li");$imgGalleryPrev=$("#js-gallery-prev"),$imgGalleryNext=$("#js-gallery-next"),$imgGalleryNum=$imgGalleryThumb.length-1,$imgGalleryThumb.click(function(){i=$(this).index(),setMainImg(i)}),$imgGalleryPrev.click(function(){0==$imgGalleryNum&&($imgGalleryNum=$imgGalleryThumb.length),$imgGalleryNum--,setMainImg($imgGalleryNum)}),$imgGalleryNext.click(function(){$imgGalleryNum==$imgGalleryThumb.length-1&&($imgGalleryNum=-1),$imgGalleryNum++,setMainImg($imgGalleryNum)});var $imgGalleryModal=$("#js-gallery-modal"),$imgGalleryOpen=$("#js-gallery-zoom"),$imgGalleryClose=$imgGalleryModal.find(".modal-close");$buyModal=$("#js-buy-modal"),$buyModalOpen=$("#js-buy-btn"),$buyModalClose=$buyModal.find(".modal-close"),$queryModal=$("#js-query-modal"),$queryModalOpen=$("#js-query-btn"),$queryModalClose=$queryModal.find(".modal-close"),$imgGalleryOpen.click(function(){$getImgSrc=$imgGalleryMain.find("img").attr("src"),$bigImgSrc=$getImgSrc.replace("gallery-tile","gallery"),$imgGalleryModal.find("img").length?$imgGalleryModal.find("img").attr("src",$bigImgSrc):($bigImgNew='<img src="'+$bigImgSrc+'" >',$imgGalleryModal.append($bigImgNew)),modalOpen($imgGalleryModal)}),$imgGalleryClose.click(function(){modalClose($imgGalleryModal)}),$buyModalOpen.click(function(){modalOpenSmall($buyModal)}),$queryModalOpen.click(function(){modalOpenSmall($queryModal)}),$buyModalClose.click(function(){modalClose($buyModal)}),$queryModalClose.click(function(){modalClose($queryModal)});var $imgGalleryVideo=$imgGalleryFull.find(".product-video");$imgGalleryVideo.click(function(e){var t=$(this).data("video");$.get(fileSrc.admin,{src:t,action:"jr_getVid"},setVideo),modalOpen($imgGalleryModal)});var $form=$(".js_contact_form"),$formInputsReq=$form.find(".req"),$formInputsOptional=$form.find(":not(.req)"),$formNextBtn=$form.find(".js_nextBtn"),$formBackBtn=$form.find(".js_backBtn"),$formBlips=$form.next(".form-progress").find(".progress-blip"),formErrorList=[];$form.attr("novalidate",""),$form.submit(function(e){formErrorList=[],$thisForm=$(this),$response=$thisForm.find(".response"),e.preventDefault(),$thisForm.find($formInputsReq).each(function(){$el=$(this),formValidate($el)}),$response.removeClass("success").removeClass("error").empty(),0==formErrorList.length?($response.addClass("loading"),$.get(fileSrc.admin,{keyword:$thisForm.serialize(),action:"jr_formsubmit",url:window.location.href}).done(formAjaxReply($thisForm))):$response.addClass("error").html("Please fill in required items")}),$formNextBtn.click(function(e){$thisSubForm=$(this).closest("fieldset.subform-active"),$subFormIndex=$thisSubForm.index(),formErrorList=[],$response=$thisSubForm.find(".response"),$thisSubForm.find($formInputsReq).each(function(){$el=$(this),formValidate($el)}),$response.removeClass("success").removeClass("error").empty(),0==formErrorList.length?($thisSubForm.removeClass("subform-active").next("fieldset").addClass("subform-active"),$formBlips.eq($subFormIndex).addClass("active")):$response.addClass("error").html("Please fill in required items")}),$formBackBtn.click(function(e){$thisSubForm=$(this).closest("fieldset.subform-active"),$thisSubForm.removeClass("subform-active").prev("fieldset").addClass("subform-active"),$subFormIndex=$thisSubForm.index(),$formBlips.eq($subFormIndex-1).removeClass("active")}),$formInputsReq.change(function(e){$el=$(this),formValidate($el)}),$formInputsOptional.change(function(e){$el=$(this),$el.val().length>0?$el.addClass("success"):$el.removeClass("success")}),$itemTabFrame=$("#js-tabs-frame"),$itemTabToggle=$itemTabFrame.find(".tab-toggle"),$itemTabToggle.click(function(){$(this).closest("section").toggleClass("active").siblings("section").removeClass("active")}),$itemSpecsBox=$("#js-specs-list"),$itemSpecsBtn=$("#js-specs-copy"),$itemSpecsBtn.click(function(){fix=$itemSpecsBox.html().replace(/(<li>)|(\s\s+)|(<img.*alt=")|("><a.*<\/a>)/g,"").replace(/<\/li>/g,"<br>"),el=document.createElement("p"),el.className="item-dimensions tile-inner",el.innerHTML=fix,$itemSpecsBox.after(el),$itemSpecsBox.remove(),$itemSpecsBtn.remove()});